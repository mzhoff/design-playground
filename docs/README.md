...
Нулевой этап закрыт. Репозиторий пока намеренно не является готовым продуктом дизайн-системы: сейчас мы поднимаем минимальные runtime-поверхности, чтобы следующие задачи могли безопасно переносить и показывать компоненты.
